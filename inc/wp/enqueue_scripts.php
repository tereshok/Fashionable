...
add_action('wp_enqueue_scripts', function(){
  ...
  wp_enqueue_script('bootstrap-bundle-min', get_template_directory_uri() . '/scripts/bootstrap.bundle.min.js');
  wp_enqueue_script('jquery-fancybox', get_template_directory_uri() . '/scripts/jquery.fancybox.min.js');
  wp_enqueue_script('slick-js', get_template_directory_uri() . '/scripts/slick.min.js');
